...
public class DataHolder {
    ...
    public void init() {
        ...
        users.add(new User("Jelena","Mikan", new Address("Partizanska","16","Skopje","Macedonia","1000"),
                "jelena.mikan@gmail.com","admin",passwordEncoder.encode("admin"),userRoleRepository.findById("ROLE_ADMIN")
                .orElseThrow(RuntimeException::new)));

        users.add(new User("Dragana","Nikolovska",new Address("Ilindenska", "24", "Skopje", "Macedonia", "1000"),
                "dragana.nikolovska@gmail.com", "customer",passwordEncoder.encode("customer"),userRoleRepository.findById("ROLE_CUSTOMER")
                .orElseThrow(RuntimeException::new)));
